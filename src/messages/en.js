module.exports = {
  ...
  sections: {
    ...
    pricing: [
      'What We Build',
      '',
      'Angelinix designs automation and business systems around the way your team works:',
      '',
      '💬 Messenger automation',
      'Telegram, WhatsApp and Instagram flows for leads, orders, support, reminders and broadcasts.',
      '',
      '📋 CRM & admin dashboards',
      'Client records, pipelines, order control, analytics, reporting and team workflows.',
      '',
      '🌐 Websites & landing pages',
      'Business sites, offer pages, booking flows, catalogs and lead capture.',
      '',
      '🤖 AI assistants',
      'Lead qualification, replies, summaries, routing, content support and workflow helpers.',
      '',
      '🧩 Custom SaaS & business systems',
      'Private tools for operations, sales, delivery, approvals, inventory and client portals.',
      '',
      '🔗 Integrations & API workflows',
      'Connections between bots, sites, forms, spreadsheets, CRM tools, payments, analytics and internal systems.',
      '',
      'Project scope and pricing are determined after a short consultation.'
    ].join('\n'),
    capabilities: [
      '<b>⚡️ Capabilities</b>',
      '',
      ...
      '',
      '📋 CRM',
      'Lead tracking, client records, pipeline stages and handoff history.',
      '',
      '📊 Analytics',
      'Dashboards for traffic, sales, conversion, performance and customer activity.',
      '',
      '📣 Broadcasts',
      'Telegram, WhatsApp and channel campaigns for offers, updates and reactivation.',
      '',
      '🔔 Reminders',
      'Follow-ups, task alerts, payment reminders, booking reminders and status notifications.',
      '',
      '🤖 Telegram Bots',
      'Storefronts, lead intake, booking flows, support flows, carts and client portals.',
      '',
      '🛠 Admin Dashboards',
      'Order control, catalog management, client management, reports and team workflows.',
      '',
      '🌐 Websites',
      'Business websites, service pages, catalog sites and client-facing portals.',
      '',
      '🎯 Landing Pages',
      'Offer pages, lead capture, campaign pages and booking pages.',
      '',
      '💳 Payment Systems',
      'Checkout flows, payment status tracking, invoice support and order confirmation.',
      '',
      '🔗 Integrations',
      'Telegram, WhatsApp, websites, forms, spreadsheets, CRM tools, analytics and payment providers.',
      '',
      '✨ AI Automation',
      'Message drafting, lead qualification, summaries, routing, content support and workflow assistants.',
      '',
    ...
    integrations: [
      '<b>🔗 Integrations</b>',
      '',
      'Angelinix can connect existing business tools into one cleaner workflow:',
      '',
      '💬 Communication',
      'Telegram, WhatsApp, Instagram, email.',
      '',
      '🌐 Web',
      'Websites, landing pages, forms and portals.',
      '',
      '📊 Data & CRM',
      'Google Sheets, CRM systems, analytics platforms.',
      '',
      '💳 Payments & APIs',
      'Payment providers, custom APIs and internal systems.',
      '',
      '🤖 AI',
      'AI assistants for replies, summaries, routing and workflow support.',
      '',
